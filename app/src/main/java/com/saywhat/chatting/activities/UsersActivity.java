...
import com.saywhat.chatting.adapters.UsersAdapter;
import com.saywhat.chatting.databinding.ActivityUsersBinding;
                ...
                .addOnCompleteListener(task -> {
                    ...
                    if (task.isSuccessful() && task.getResult() != null) {
                        ...
                        for (QueryDocumentSnapshot queryDocumentSnapshot : task.getResult()) {
                            ...
                            Log.d("UserImageDebug", "Image String: " + user.image);
